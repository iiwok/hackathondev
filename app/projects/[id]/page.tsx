...
export default async function ProjectDetailPage({ params }: { params: { id: string } }) {
  ...
  const sampleProjects: Record<number, Project> = {
    ...
    2: {
      ...
      description: 'AI-powered mental health companion that offers personalized mindfulness exercises. MindMesh uses machine learning to adapt to your emotional patterns and provide targeted meditation, breathing exercises, and cognitive behavioral therapy techniques. The app includes mood tracking, sleep analysis, and a journal feature.',
    ...
    3: {
      ...
      description: 'Secure wallet for cryptocurrency that uses biometric authentication. CryptoSafe implements multi-factor authentication including fingerprint, facial recognition, and voice verification to ensure maximum security for digital assets. The wallet supports multiple cryptocurrencies and includes real-time market tracking and transaction history.',
    ...
    4: {
      ...
      description: 'Augmented reality application that helps identify plants and provides care information. ARLens uses computer vision to recognize thousands of plant species and overlays care instructions, growth patterns, and compatibility with your local climate. The app includes reminders for watering and fertilization based on each plant's specific needs.',
    ...
    5: {
      ...
      description: 'Audio visualization tool that creates stunning visuals from music in real-time. SoundScape analyzes audio input to generate dynamic, responsive visual patterns that react to rhythm, frequency, and volume. The application allows users to customize visualization styles and export videos for sharing on social media or use in live performances.',
    ...
    6: {
      ...
      description: 'Mobile app that scans food items and provides nutritional information instantly. NutriScan uses image recognition to identify foods and ingredients, providing detailed nutritional data including calories, macronutrients, vitamins, and potential allergens. The app includes meal planning tools, dietary restriction options, and personalized health goals.',
      image_url: '/sample-blue.jpg',
      created_at: new Date().toISOString(),
    },
  };
